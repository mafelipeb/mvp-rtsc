    ...
    try {
      ...
      coaching = {
        phase: {
          ...
          stage: 'Qualification',
          context: 'Gathering initial information from prospect'
        },
        action: {
          script: 'Tell me more about your current process',
          language: 'EN'
        },
        tip: {
          insight: 'Continue active listening to build rapport',
          rationale: 'Understanding pain points leads to better solution fit'
        },
        risk: {
          warning: 'Insufficient discovery may lead to misalignment',
          consequence: 'Could propose wrong solution or pricing'
        },
        metrics: {
          discovery: 30,
          pain_quantified: 20,
        ...
        next: {
          action: 'Ask about business impact and timeline',
          timeline: 'immediate'
        }
      };
    }
...
Respond with a JSON object:
{
  ...
  "sentiment": "positive|neutral|negative"
    ...
    const message = await anthropic.messages.create({
      model: 'claude-3-haiku-20240307', // Updated to stable Haiku model
      max_tokens: 200,
      temperature: 0.5,
      system: systemPrompt,
      messages: [
