...
class CallStorage {
  constructor() {
    this.calls = new Map();
    this.customPrompt = null; // Store custom prompt template
  }
  ...
  /**
   * Set custom coaching prompt template
   * @param {string|null} prompt - Custom prompt template or null to reset
   */
  setPrompt(prompt) {
  ...
  /**
   * Get custom coaching prompt template
   * @returns {string|null} Custom prompt or null if using default
   */
  getPrompt() {
